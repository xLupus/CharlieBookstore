            ...
            <nav class="container-xxl">
                ...
                <div class="offcanvas offcanvas-end" data-bs-scroll="true" data-bs-backdrop="false" id="navbarOffCanvas">
                    ...
                    <div class="offcanvas-body align-items-center">
                        ...
                        <ul class="navbar-nav flex-column flex-xl-row mt-2 mt-xl-0 pt-xl-0 justify-content-center justify-content-xl-none align-items-center align-items-xl-none">
                            ...
                            <li class="nav-item p-3 ps-xl-4 pe-xl-1 position-relative">
                                ...
                                <span class="badge rounded-5 position-absolute bottom-50 translate-middle-x" style="background-color: #B75C3D;">7</span>
                            </li>
                        </ul>
                    </div>
                </div>
