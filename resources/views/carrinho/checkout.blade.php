...
<main class="container-xxl">
    <div class="row row-cols-2">
        <div class="col col-8 mb-5">
            ...
            <div class="row mb-4">
                <div class="w-75 px-3 ms-3">
                    <span class="d-block fw-bold h5 mb-3">Forma de Pagamento</span>

                    <div class="d-flex justify-content-between">
                        <button type="button" class="btn btn-light rounded-pill px-4 py-3 border" data-bs-toggle="button">Boleto Bancario</button>
                        <button type="button" class="btn btn-light rounded-pill px-4 py-3 border" data-bs-toggle="button">Cartão de crédito</button>
                        <button type="button" class="btn btn-light rounded-pill px-4 py-3 border" data-bs-toggle="button">Transferencia Bancaria</button>
                        <button type="button" class="btn btn-light rounded-pill px-4 py-3 border" data-bs-toggle="button">PIX</button>
                    </div>
                </div>
            </div>
