        ...
        <div class="d-flex flex-column align-items-center container-xxl px-0">
            <div class="row container-xxl d-flex justify-content-between pb-4 pt-5">
                <div class="col col-2 px-0">
                    ...
                    <ul class="px-0">
                        <li class="mb-3"><a href="#" class="text-white">Categorias</a></li>
                        <li><a href="#" class="text-white">Lançamentos</a></li>
                    </ul>
                </div>
                <div class="col col-3 px-0">
                    <div class="fs-5 mb-4 text-center">
                        <span class="text-white fw-bold">Confira Nossas Redes:</span>
                    </div>
                    <ul class="d-flex justify-content-around ps-0 pt-3 sociais">
                        <li>
                ...
                <div class="col col-2 px-0">
                    ...
                    <a href="#" class="text-white pt-3">Entrar</a>
                </div>
            </div>
            <div class="py-4 text-center">
                <span class="text-white">©2022 Charlie BookStore - All Rights Reserved</span>
            </div>
        </div>
    </footer>
