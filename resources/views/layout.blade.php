...
<body>
    ...
    <footer>
        <div class="container-xxl">
            <div class="row row-cols-xl-4 row-cols-md-2 row-cols-1 pt-4 pb-2 px-0 gy-3 gy-xl-0">
                ...
                <div class="col d-flex justify-content-center align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="currentColor" class="bi bi-telephone rounded-circle bg-white p-2 ms-1 ms-xl-0" viewBox="-1.2 -1.7 17.3 20">
                ...
                <div class="col d-flex justify-content-center align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="currentColor" class="bi bi-envelope rounded-circle bg-white p-2 ms-1 ms-xl-0" viewBox="-0.7 -2 17 20">
